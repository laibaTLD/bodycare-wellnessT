...
export const ServiceDetails: React.FC<ServiceDetailsProps> = ({ details, className }) => {
  ...
  return (
    <section
      id="service-details"
      className={cn('relative flex h-full min-h-full flex-col overflow-hidden', className)}
      style={{ backgroundColor: colors.pageBackground }}
    >
      <div
        ref={triggerRef}
        className="flex h-full flex-1 flex-col justify-center px-6 py-12 text-center sm:px-8 sm:py-14 lg:px-10 lg:py-16"
      >
        <p
